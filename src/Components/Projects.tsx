...
const projectsData: Project[] = [
    ...
    },
    {
        id: 2,
        category: "AI/ML",
        title: "ResumeIQ - AI Resume Analyzer & ATS Score Predictor",
        description: "An AI-powered resume analyzer that classifies resumes using a Bidirectional GRU model, performsATS skill matching against job descriptions, calculates ATS scores, and provides personalized improvement suggestions.",
        thumbnailUrl: "/resume-analyzer-thumbnail.png",
        techTags: ["Python", "TensorFlow/Keras", "NLTK", "Pandas", "NumPy", "Scikit-learn", "Streamlit"],
        liveDemo: "https://ai-resume-analyzer-ats-score-predictor-dkwwcvudurzghroipkurft.streamlit.app/",
        githubRepo: "https://github.com/Abhinavsharma005/AI-Resume-Analyzer-ATS-Score-Predictor",
    },
    {
        id: 3,
        category: "Full-Stack",
    ...
    },
    {
        ...
        description: "Multi-Disease Prediction System integrating Symptom-Based Disease, Heart Disease, Mental Health Risk, and Diabetes prediction. Implemented and evaluated multiple ML models, selecting Decision Tree, KNN, Random Forest, and Decision Tree based on the best predictive performance.",
        thumbnailUrl: "/multidisease-prediction thumbnail.png",
        techTags: ["Python", "Scikit-learn", "Pandas", "NumPy", "Matplotlib", "Seaborn", "Streamlit"],
        liveDemo: "https://multi-disease-prediction-system-pwsacx7gmsbpdslqtvwa9p.streamlit.app/",
        githubRepo: "https://github.com/Abhinavsharma005/Multi-Disease-Prediction-System",
    },
    {
        id: 5,
        category: "App Dev",
